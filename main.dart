          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: NetworkImage(
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2Z2Lz8UEErxjiFGAb_vAQc4-CmWHp7IgziA&usqp=CAU'),
                fit: BoxFit.cover,
              ),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1rDfrs3Jus3ipD957uVhKr-fwHxIoaknlDYPSeFBrZss__1hOC33CPT0f8AD59tvCDMk&usqp=CAU'),
                  fit: BoxFit.cover,
                ),
                borderRadius: BorderRadius.all(Radius.circular(90.0)),
              ),
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                      'https://icons.iconarchive.com/icons/alecive/flatwoken/512/Apps-Chat-icon.png'),
                  fit: BoxFit.cover,
                ),
                borderRadius: BorderRadius.all(Radius.circular(90.0)),
              ),
